...
As a major fan of this city simulator, I noticed the only way to enable a modern installation was to run binaries posted on Reddit/game knowledge sites that may be dead or have little to no documetation. As a challenge, I opted to create a modern, open source version of these binaries that achieve feature parity with their intended use. 

The most relevent, up to date resource with documentation is located here:
...
These are amazing projeects and I highly suggest looking at them. Despite these, I wanted to create this project to do the following:
